                                            ...
                                            <div class="card-body">
                                                <table class="table table-sm table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <input type="number" class="form-control form-control-sm" name="phone" value="{{ $users->nomor_telepon }}">
                                                            @error('phone')
                                                            <small class="text-danger">{{$message}}</small>
                                                            @enderror
                                                        </td>
                                            ...
                                            <div class="card-body">
                                                <table class="table table-sm table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <input type="text" value="" name="jalan" class="form-control form-control-sm">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>Status</th>
